...
public class GlobalConstants
{
	...
	final public static int LOGIN_FAILED_NOTUSER = 0x110005;
	...
	final public static int CONTACT_SUCCESS = 0x110026;
	final public static int CONTACT_NO_DATA = 0x1010026;

	final public static int VISIT_SUCCESS = 0x11002f;
	final public static int VISIT_NO_DATA = 0x101002f;
	public static final int NO_UPDATE = 0x1010002;//--资源更新

	public static final int RESOURCE_UPDATE  = 0x1110002;//--无更新
}
