...
-- ----------------------------
-- Table structure for tbl_agency_card
-- ----------------------------
DROP TABLE IF EXISTS `tbl_agency_card`;
...
DROP TABLE IF EXISTS `tbl_card_consume_log`;
...
CREATE TABLE `tbl_player` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13111 DEFAULT CHARSET=utf8;

/*Table structure for table `tbl_player_card_consume_log` */

DROP TABLE IF EXISTS `tbl_player_card_consume_log`;
...
DROP TABLE IF EXISTS `tbl_update_version`;
