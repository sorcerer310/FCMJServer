...
public class LoginService {
     ...
     */
    public static void updateUserCard(int uid,int sub,int nowcard,String room) throws PersistException {
        ...
        String detail = "INSERT INTO tbl_card_detail(id,userid,card_consume,card_current,consume_type,room,time) VALUES (?,?,?,?,?,?,?)";
        ...
        try {
            ...
            UUID uidx=UUID.randomUUID();

            String ts[]=uidx.toString().split("-");
            String str="";
            for(String s:ts)
            {
                str=str+s;
