...
//        抢杠胡
        Integer[] aCards = {11, 13, 14, 15, 16, 17, 18, 19, 18, 18, 18, 29, 29};
        Integer[] bCards = {11, 12, 17, 22, 25, 12, 41, 42, 43, 46, 46, 46, 46};
        Integer[] cCards = {12, 12, 12, 31, 25, 25, 25, 29, 29, 29, 32, 32, 32};
        Integer[] dCards = {41, 41, 41, 45, 42, 42, 42, 45, 43, 43, 43, 44, 44};

        //抢杠小胡
//        Integer[] aCards = {39, 19, 18, 17, 16, 22, 23, 24, 28, 28, 28, 39, 39};
//        Integer[] bCards = {11, 12, 17, 13, 16, 12, 41, 42, 43, 46, 46, 46, 46};
//        Integer[] cCards = {12, 12, 12, 31, 25, 25, 25, 29, 29, 29, 32, 32, 32};
//        Integer[] dCards = {41, 41, 41, 45, 42, 42, 42, 45, 43, 43, 43, 44, 44};
...
//        Integer[] dCards = {12, 14, 16, 18, 18, 18, 18, 19, 26, 26, 27, 28, 29};
        ...
        //门前清自摸 本风分数测试
//        Integer[] aCards = {14, 21, 13, 24, 27, 29, 23, 16, 16, 16, 12, 21, 22};
//        Integer[] bCards = {14, 21, 13, 24, 27, 29, 23, 11, 11, 11, 12, 21, 22};
//        Integer[] cCards = {14, 21, 13, 24, 27, 29, 23, 16, 16, 16, 12, 21, 22};
//        Integer[] dCards = {14, 21, 13, 24, 27, 29, 23, 16, 16, 16, 12, 21, 22};
...
//        Integer[] dCards = {14, 16, 17, 14, 18, 18, 17, 12, 11, 11, 12, 21, 22};
        ...
        //一条龙
//        Integer[] aCards = {11, 12, 13, 14, 15, 45, 17, 18, 19, 41, 41, 41, 45};
//        Integer[] bCards = {21, 22, 23, 24, 25, 46, 27, 28, 29, 42, 42, 42, 46};
//        Integer[] cCards = {31, 32, 33, 34, 35, 47, 37, 38, 39, 43, 43, 43, 47};
//        Integer[] dCards = {11, 12, 13, 14, 15, 47, 17, 18, 19, 44, 44, 44, 47};
        //清一色一条龙
//        Integer[] aCards = {11, 12, 13, 14, 15, 17, 18, 19, 11, 11, 11, 12,12};
//        Integer[] bCards = {21, 22, 23, 24, 25, 27, 28, 29, 21, 21, 21, 22,22};
//        Integer[] cCards = {31, 32, 33, 34, 35, 37, 38, 39, 31, 31, 31, 32, 32};
//        Integer[] dCards = {11, 12, 13, 14, 15, 17, 18, 19, 11, 11, 11, 12, 12};

        //一条龙问题牌型重现
//        Integer[] aCards = {34, 34, 31, 32, 33, 35, 36, 37, 37, 37, 38, 39, 41};
//        Integer[] bCards = {21, 22, 23, 24, 25, 26, 27, 28, 29, 42, 42, 42, 39};
//        Integer[] cCards = {31, 32, 33, 34, 35, 35, 36, 36, 37, 37, 38, 41, 41};
//        Integer[] dCards = {15, 15, 16, 17, 18, 31, 32, 33, 34, 35, 37, 38, 39};

        //杠上开花测试
//        Integer[] aCards = {11,11, 11, 11, 12, 13, 14, 15, 16, 18, 18, 18, 19};
//        Integer[] bCards = {46, 22, 23, 24, 25, 26, 27, 28, 29, 42, 42, 42, 46};
//        Integer[] cCards = {32, 32, 33, 34, 35, 36, 37, 38, 39, 43, 43, 43, 32};
//        Integer[] dCards = {47,12, 13, 14, 15, 16, 17, 18, 19, 44, 44, 44, 47};

        //同一圈不能胡第二张，不能碰第二张
//        Integer[] aCards = {41, 42, 26, 28, 28, 28, 28, 29, 36, 36, 37, 38, 39};
//        Integer[] bCards = {41, 42, 22, 24, 24, 24, 24, 25, 36, 36, 37, 38, 39};
//        Integer[] cCards = {42, 42, 41, 41, 46, 46, 46, 47, 47, 47, 45, 45, 45};
//        Integer[] dCards = {41, 42, 16, 18, 18, 18, 18, 19, 26, 26, 27, 28, 29};

        //随意测试牌
//        Integer[] aCards = {11, 11, 11, 12, 12, 12, 12, 13, 15, 16, 16, 17, 18};
//        Integer[] bCards = {41, 42, 22, 24, 24, 24, 24, 25, 36, 36, 37, 38, 39};
//        Integer[] cCards = {42, 42, 41, 41, 46, 46, 46, 47, 47, 47, 45, 45, 45};
//        Integer[] dCards = {41, 42, 16, 18, 18, 18, 18, 19, 26, 26, 27, 28, 29};

        //七对门前清
//        Integer[] aCards = {11, 11, 12, 12, 13, 13, 22, 22, 15, 15, 17, 17, 18};
//        Integer[] bCards = {11, 11, 12, 12, 13, 13, 22, 22, 15, 15, 17, 17, 18};
//        Integer[] cCards = {11, 11, 12, 12, 13, 13, 22, 22, 15, 15, 17, 17, 18};
//        Integer[] dCards = {11, 11, 12, 12, 13, 13, 22, 22, 15, 15, 17, 17, 18};
